...
<td ng-if="<?php echo $admin;?>==1 && res.Status=='Closure'">
<input type="text" class="form-control" placeholder="Total Time Client in min" name="actime" ng-model="res.Ticket_ID"></td><td ng-if="<?php echo $admin;?>==1 && res.Status=='Closure'">
