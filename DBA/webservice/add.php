...
/*-----------------------------------------------------*/
$sql3="select count(*) as ccount from dbo.Master_Ticket_Tab where Assign_to like '".$resolver."' and Status='WIP' and team='DBA'";
//echo $sql3;
  ...
  while($row3=$result->fetch())
{
	if($row3['ccount']!=0)
	{
	$sql="update Status_count set Wip=".$row3['ccount']." where Email like '%".$r."%' and Team='DBA'";
	//echo $resolver[0].",Classify: $row3['ccount']";
	echo $sql;
    ...
    $sql="update Status_count set Wip=0 where Email like '%".$r."%' and Team='DBA'";
    echo $sql;
  }
  $conn->query($sql);
	//$rows[]=$row3;
...
/*-----------------------------------------------------*/
$sql3="select count(*) as ccount from dbo.Master_Ticket_Tab where Assign_to like '".$resolver."' and Status='Review' and team='DBA'";
//echo $sql3;
  ...
  while($row3=$result->fetch())
{
	if($row3['ccount']!=0)
	{
	$sql="update Status_count set Review=".$row3['ccount']." where Email like '%".$r."%' and Team='DBA'";
	//echo $resolver[0].",Classify: $row3['ccount']";
	//echo $sql;
    ...
    $sql="update Status_count set Review=0 where Email like '%".$r."%' and Team='DBA'";
  }
  $conn->query($sql);
	//$rows[]=$row3;
...
/*-----------------------------------------------------*/
$sql3="select count(*) as ccount from dbo.Master_Ticket_Tab where Assign_to like '".$resolver."' and Status='AUI' and team='DBA'";
//echo $sql3;
  ...
  while($row3=$result->fetch())
{
	if($row3['ccount']!=0)
	{
	$sql="update Status_count set Aui=".$row3['ccount']." where Email like '%".$r."%' and Team='DBA'";
	//echo $resolver[0].",Classify: $row3['ccount']";
	//echo $sql;
    ...
    $sql="update Status_count set Aui=0 where Email like '%".$r."%' and Team='DBA'";
  }
  $conn->query($sql);
	//$rows[]=$row3;
...
$sql3="select count(*) as ccount from dbo.Master_Ticket_Tab where Assign_to like '".$resolver."' and Status='Doc' and team='DBA'";
//echo $sql3;
  ...
  while($row3=$result->fetch())
{
	if($row3['ccount']!=0)
	{
	$sql="update Status_count set Doc=".$row3['ccount']." where Email like '%".$r."%' and Team='DBA'";
	//echo $resolver[0].",Classify: $row3['ccount']";
	//echo $sql;
    ...
    $sql="update Status_count set Doc=0 where Email like '%".$r."%' and Team='DBA'";
  }
  $conn->query($sql);
	//$rows[]=$row3;
...
$sql3="select count(*) as ccount from dbo.Master_Ticket_Tab where Assign_to like '".$resolver."' and Status='Closure' and team='DBA'";
//echo $sql3;
  ...
  while($row3=$result->fetch())
{
	if($row3['ccount']!=0)
	{
	$sql="update Status_count set Closure=".$row3['ccount']." where Email like '%".$r."%' and Team='DBA'";
	//echo $resolver[0].",Classify: $row3['ccount']";
	//echo $sql;
    ...
    $sql="update Status_count set Closure=0 where Email like '%".$r."%' and Team='DBA'";
  }
  $conn->query($sql);
	//$rows[]=$row3;
