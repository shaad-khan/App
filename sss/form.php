...
"></span></label> </td><td ng-if="items[0].Status=='WIP' && !items[0].jobtype">
    <select ng-if="jjf==2" class="form-control" name="jtype" required >
...
"></span></label></td><td ng-if="items[0].Status=='Classify'">
    ...
    <input ng-if="nitems[0].Mins" type="hidden" class="form-control" name="ttime" id="exampleInputEmail1" value="{{nitems[0].Mins}}">
    <input ng-if="nitems[0].Mins" type="number" class="form-control" name="ttime2" id="exampleInputEmail1" value="{{nitems[0].Mins}}" placeholder="Time In min" disabled>
