...
"></span></button></div>
    <div class="panel-body" ng-init="User='<?php Echo $user_session;?>'"><form class="form-inline" action="webservice/add.php" method="POST"> 
...
if($_SESSION['Doc']==1)
{?>
  <tr ng-if="items[0].Resolver == User && items[o].Status=='Doc'"><td>{{User}}
    <div class="form-group" >
