...
"></span></button><button type="button" class="btn btn-primary"><a href="attach.php?tid=<?php Echo $ID;?>" style="text-decoration:none"><span class="glyphicon glyphicon-paperclip
"></span></a></button></div>
