...
<td>{{res.Password}}</td>
<td><button type="button" class="btn btn-info" data-toggle="modal" data-toggle="#myModal" data-ticket-id="{{res.Id}}" data-target=".bs-example-modal-lg"><span class="glyphicon glyphicon-edit
